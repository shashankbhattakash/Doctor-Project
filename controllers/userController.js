...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'akashbhatt5227@gmail.com', // this is the email that will be used to send the email.
        pass: 'vuau uoyl iwpm huur', //this is the password that is created in app passwords in gmail setting options.
    },
});
